...
function createRoutes(){
    return [
        ...
        {
            path: '/microprofile/01_overview',
            meta: {
                h1: 'Overview',
                title: 'Overview',
                description: 'Helidon Microprofile overview',
                keywords: 'helidon, microprofile, micro-profile',
                customLayout: null,
                hasNav: true
            },
            component: loadPage('microprofile-01_overview', '/microprofile/01_overview', {})
        },
        {
            path: '/microprofile/02_introduction',
            meta: {
            ...
            component: loadPage('microprofile-02_introduction', '/microprofile/02_introduction', {})
        },
        {
...
function createNav(){
    return [
        ...
        },
        {
            ...
            group: '/microprofile',
            items: [
                { href: '/microprofile/01_overview', title: 'Overview' },
                { href: '/microprofile/02_introduction', title: 'Microprofile Introduction' },
