...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="/getting-started/02_base-example"><div class="card__link-hover"/>
</router-link>
...
<v-flex xs12 sm4 lg3>
<v-card>
<router-link to="#microprofile/01_introduction.adoc" @click.native="this.scrollFix('#microprofile/01_introduction.adoc')"><div class="card__link-hover"/>
</router-link>
<v-layout align-center justify-center class="">
<v-avatar size="150px">
