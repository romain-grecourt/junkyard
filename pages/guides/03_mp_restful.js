...
<v-card-text>
<dl>
<dt slot=title>MP REST Application</dt>
<dd slot="desc"><p>Create and build a RESTful application using Helidon MicroProfile and
 JAX-RS.</p>
</dd>
</dl>
</v-card-text>
...
<div class="section">
<p>You&#8217;ll learn how to use Helidon MicroProfile quickly to create a JAX-RS RESTful
...
<p>The finished code for this example is available <a id="" title="" target="_blank" href="https://github.com/oracle/helidon/tree/1.0.0-SNAPSHOT/examples/guides/mp-restful">here</a>.</p>
...
>mvn archetype:generate -DinteractiveMode=false \
    ...
    -DartifactId=mp-restful \
    -Dpackage=io.helidon.guides.mp.restful</markup>
...
public class CheckLiveness implements HealthCheck { <span class="conum" data-value="3" />
    ...
    /**
     * Reports the health of the greeting resource.
     *
...
<div class="section">
<p>MicroProfile provides some metrics check out-of-the-box. You can use <code>curl</code> to
 get the metrics data.</p>
...
<p>You should see a response with the following item:
 <code>io_helidon_guides_mp_restfulwebservice_greet_resource_accessctr 4</code></p>
