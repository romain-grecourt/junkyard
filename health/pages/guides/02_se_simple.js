...
<v-card-text>
<dl>
<dt slot=title>SE Web Application</dt>
<dd slot="desc"><p>Create and build a web application using Helidon SE.</p>
</dd>
</dl>
</v-card-text>
</v-card>
...
<div class="section">
<p>You&#8217;ll learn how to use Helidon quickly to create a web application in
 three main steps:</p>
...
<p>The finished code for this example is available <a id="" title="" target="_blank" href="https://github.com/oracle/helidon/tree/1.0.0-SNAPSHOT/examples/guides/se-simple">here</a>.</p>
...
>mvn archetype:generate -DinteractiveMode=false \
    ...
    -DartifactId=se-simple \
    -Dpackage=io.helidon.guides.se.simple</markup>

<markup
lang="bash"
title="Build the application"
>cd se-simple ; mvn package</markup>
...
>java -jar target/se-simple.jar</markup>
