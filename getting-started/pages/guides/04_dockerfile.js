...
<tr>
<td><router-link to="#getting-started/03_prerequisites.adoc" @click.native="this.scrollFix('#getting-started/03_prerequisites.adoc')">Helidon Prerequisites</router-link></td>
</tr>
<tr>
...
<p>The Helidon team recommends setting-up the class-path inside the
 ...
 <a id="" title="" target="_blank" href="https://github.com/oracle/helidon/tree/1.0.1-SNAPSHOT/examples/quickstarts/helidon-quickstart-se">examples</a> for more details on how to package your
